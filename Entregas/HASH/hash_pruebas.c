...
static void prueba_hash_insertar()
{
    ...
    hash_borrar(hash, clave2);
    hash_borrar(hash, clave3);
...
static void prueba_hash_borrar_con_destruir()
{
    hash_t* hash = hash_crear(free);

    char *clave1 = "perro", *valor1a;
    char *clave2 = "gato", *valor2a;
...
void pruebas_hash_catedra()
{
    ...
    prueba_hash_borrar_con_destruir();
    prueba_hash_borrar();
